...
export const ContactPage = () => {
  ...
  const [selectedMapBranch, setSelectedMapBranch] = useState(branches[0]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <a
            ...
            className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-emerald-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400">WhatsApp Sales</p>
              <p className="text-sm font-bold text-slate-900 mt-0.5">{shopContact.displayWhatsapp}</p>
              <span className="text-xs text-emerald-600 font-semibold group-hover:underline">Chat Now &rarr;</span>
            </div>
          </a>

          <a
            href={`tel:${shopContact.primaryPhone}`}
            className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-blue-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Call Direct</p>
              <p className="text-sm font-bold text-slate-900 mt-0.5">{shopContact.primaryPhone}</p>
              <span className="text-xs text-blue-600 font-semibold group-hover:underline">Call Store &rarr;</span>
            </div>
          </a>

          <a
            href={`mailto:${shopContact.supportEmail}`}
            className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-indigo-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-bold text-slate-900 mt-0.5 truncate">{shopContact.supportEmail}</p>
              <span className="text-xs text-indigo-600 font-semibold group-hover:underline">Send Email &rarr;</span>
            </div>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-amber-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Google Maps</p>
              <p className="text-sm font-bold text-slate-900 mt-0.5">Deans Trade Center</p>
              <span className="text-xs text-amber-600 font-semibold group-hover:underline">Open Map &rarr;</span>
            </div>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {branches.map((branch) => {
            const isSelectedForMap = selectedMapBranch.id === branch.id;
            return (
              <div
                key={branch.id}
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-slate-900">{branch.name}</h3>
                    <p className="text-xs text-slate-500 font-medium mt-0.5">Manager: {branch.manager}</p>
                  </div>
                  ...
                  <div className="space-y-2.5 text-xs text-slate-600 pt-2 border-t border-slate-100">
                    ...
                    <p className="flex items-center gap-2.5">
                      ...
                      <a href={`tel:${branch.phone}`} className="hover:text-blue-600 font-semibold">
                        {branch.phone}
                      </a>
                    </p>
                    <p className="flex items-center gap-2.5">
                      <Mail className="w-4 h-4 text-slate-400 shrink-0" />
                      <a href={`mailto:${branch.email}`} className="hover:text-blue-600 font-medium">
                        {branch.email}
                      </a>
                    </p>
                    <p className="flex items-center gap-2.5">
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="py-2.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold border border-slate-200 transition-all flex items-center gap-1"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-sm">
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-300 bg-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 cursor-pointer"
                  >
                    {branches.map((b) => (
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-70 active:scale-95"
              >
                {isSubmitting ? (
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">{selectedMapBranch.address}</p>
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-sm transition-all shrink-0"
              >
            ...
            <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden border border-slate-200 shadow-inner bg-slate-100">
              <iframe
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="text-center sm:text-left">
                <div className="text-xs font-bold text-slate-900">Need driving directions or store help?</div>
                <div className="text-xs text-slate-500">Contact {selectedMapBranch.manager} at {selectedMapBranch.displayWhatsapp}</div>
              </div>
              <div className="flex items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold shadow-sm transition-all"
                >
